...
def process_data_set(iterator_train,iterator_label,batch_idx,path,process_type,img_size = 96,random_crop=False):
    ...
    for i in pbar:
        ...
        print('tmp_train.shape:',tmp_train.shape)
        iteration += 1
...
if __name__=="__main__":
    ...
    train_filenames, label_filenames = input_setup(args)
    ...
    if args.is_train:
        ...
        # path = 'PreprocessedData28854_24.h5'
        path = 'PreprocessedDatahaze_24.h5'
        # path = 'retina120_96.h5'
